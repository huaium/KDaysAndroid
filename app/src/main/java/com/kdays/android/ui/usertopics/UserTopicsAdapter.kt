...
class UserTopicsAdapter(private val topicList: List<Topic>, private val username: String) :
    RecyclerView.Adapter<UserTopicsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.topicAuthor.text = username
