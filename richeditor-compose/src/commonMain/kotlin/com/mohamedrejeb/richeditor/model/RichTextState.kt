...
import com.mohamedrejeb.richeditor.parser.bbcode.RichTextStateBBCodeParser
        ...
        richParagraphList.toList().forEachIndexed { index, richParagraph ->
            ...
            if (!type.startRichSpan.textRange.collapsed) {
                textLayoutResult?.let { textLayoutResult ->
                    val start = textLayoutResult.getHorizontalPosition(
                        type.startRichSpan.textRange.min,
                        true
                    )
                    val end = textLayoutResult.getHorizontalPosition(
                        type.startRichSpan.textRange.max,
                        true
                    )
...
//            }
    ...
    fun toBBCode(): String {
        return RichTextStateBBCodeParser.decode(this)
    }
